...
public class RegistrarLibros extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        registrarBtn1.setBackground(new java.awt.Color(204, 102, 0));
        registrarBtn1.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        registrarBtn1.setText("Volver");
        registrarBtn1.setToolTipText("");
    ...
    private void registrarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registrarBtnActionPerformed
        ...
        if(tituloField.getText().isBlank()||autorField.getText().isBlank()||añoField.getText().isBlank()||isbnField.getText().isBlank()
            ...
            Biblioteca.librosDisponibles.add(new LibroDisponible(añoPublicacion, titulo, autor, isbn, editorial, copias));
